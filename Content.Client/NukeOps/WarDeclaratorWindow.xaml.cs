    ...
    private void UpdateStatus(WarConditionStatus status)
    {
        switch (status)
        {
            case WarConditionStatus.WarReady:
                ...
                UpdateTimer();
                StatusLabel.SetOnlyStyleClass(StyleLora.StyleClassPowerStateLow);
                break;
            case WarConditionStatus.YesWar:
                ...
                UpdateTimer();
                StatusLabel.SetOnlyStyleClass(StyleLora.StyleClassPowerStateGood);
                break;
            case WarConditionStatus.NoWarSmallCrew:
                ...
                StatusLabel.SetOnlyStyleClass(StyleLora.StyleClassPowerStateNone);
                break;
