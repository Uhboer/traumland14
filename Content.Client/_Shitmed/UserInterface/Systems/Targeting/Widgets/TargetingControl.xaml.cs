...
using Content.Client.UserInterface.Systems.Targeting.Controls;
...
public sealed partial class TargetingControl : UIWidget
{
    ...
    private SuccubusControl _control;
    ...
    public TargetingControl()
    {
        ...
        _control = new SuccubusControl();
        _control.SetSize = new Vector2(64, 64);
    ...
    {
        _control.BodyPartTextures = new Dictionary<TargetBodyPart, Texture?>();
        foreach (var item in _bodyPartControls)
        {
            ...
            _control.BodyPartTextures[item.Key] = texture;
        }
    }
