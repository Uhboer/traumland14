...
public sealed partial class ConfigTabControl : BaseTabControl
{
    ...
    public override bool UpdateState()
    {
        ...
        var laguageUIController = UserInterfaceManager.GetUIController<LanguageMenuUIController>();
        ...
        var languageButton = CreateMenuButton(
                "LanguageButton",
                Loc.GetString("ui-config-menu-language"),
                "/Textures/Interface/language.png");
        languageButton.OnPressed += (_) =>
            laguageUIController.ToggleWindow();
        MenuList.AddChild(languageButton);
