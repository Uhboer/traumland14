...
namespace Content.Client.UserInterface.Systems.Alerts.Controls
{
    public sealed class AlertControl : BaseButton
    {
        ...
        public AlertControl(AlertPrototype alert, short? severity, float iconScale = 2, float sizeX = 32, float sizeY = 32, float spriteScale = 1.0f)
        {
            ...
            {
                MaxSize = new Vector2(sizeX * iconScale, sizeY * iconScale)
            };
