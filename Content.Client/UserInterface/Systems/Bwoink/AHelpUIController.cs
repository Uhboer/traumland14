...
public sealed class AHelpUIController: UIController, IOnSystemChanged<BwoinkSystem>, IOnStateChanged<GameplayState>, IOnStateChanged<LobbyState>
{
    ...
    private MenuButton? GameAHelpButton = null; //UIManager.GetActiveUIWidgetOrNull<GameTopMenuBar>()?.AHelpButton;
    private WhiteLobbyTextButton? LobbyAHelpButton => (UIManager.ActiveScreen as LobbyGui)?.AHelpButton;
    ...
    private void UnreadAHelpReceived()
    {
        ...
        LobbyAHelpButton?.StyleClasses.Add(StyleLora.StyleClassButtonColorRed);
    ...
    private void UnreadAHelpRead()
    {
        ...
        LobbyAHelpButton?.StyleClasses.Remove(StyleLora.StyleClassButtonColorRed);
