...
";
        ...
        public void TestAlertManager()
        {
            ...
            Assert.That(lowPressure!.States[0], Is.EqualTo(new SpriteSpecifier.Texture(new ("/Textures/Interface/Alerts/Pressure/lowpressure.png"))));
            Assert.That(alertsSystem.TryGet("HighPressure", out var highPressure));
            Assert.That(highPressure!.States[0], Is.EqualTo(new SpriteSpecifier.Texture(new ("/Textures/Interface/Alerts/Pressure/highpressure.png"))));
