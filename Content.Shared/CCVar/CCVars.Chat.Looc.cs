...
public sealed partial class CCVars
{
    public static readonly CVarDef<bool> LoocEnabled =
        CVarDef.Create("finster_looc.enabled", true, CVar.NOTIFY | CVar.REPLICATED);

    public static readonly CVarDef<bool> AdminLoocEnabled =
        CVarDef.Create("finster_looc.enabled_admin", true, CVar.NOTIFY);
    ...
    public static readonly CVarDef<bool> DeadLoocEnabled =
        CVarDef.Create("finster_looc.enabled_dead", false, CVar.NOTIFY | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> CritLoocEnabled =
        CVarDef.Create("finster_looc.enabled_crit", false, CVar.NOTIFY | CVar.REPLICATED);
}
