...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool>
        GameDummyTicker = CVarDef.Create("finster_game.dummyticker", false, CVar.ARCHIVE | CVar.SERVERONLY);

    /// <summary>
    ///     Controls if the lobby is enabled. If it is not, and there are no available jobs, you may get stuck on a black screen.
    /// </summary>
    public static readonly CVarDef<bool>
        GameLobbyEnabled = CVarDef.Create("finster_game.lobbyenabled", true, CVar.ARCHIVE);

    /// <summary>
    ///     Controls the duration of the lobby timer in seconds. Defaults to 12 minutes and 0 seconds.
    /// </summary>
    public static readonly CVarDef<int>
        GameLobbyDuration = CVarDef.Create("finster_game.lobbyduration", 720, CVar.ARCHIVE);

    /// <summary>
    ///     Controls if players can latejoin at all.
    /// </summary>
    public static readonly CVarDef<bool>
        GameDisallowLateJoins = CVarDef.Create("finster_game.disallowlatejoins", false, CVar.ARCHIVE | CVar.SERVERONLY);

    /// <summary>
    ///     Controls the default game preset.
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyDefaultPreset = CVarDef.Create("finster_game.defaultpreset", "secret", CVar.ARCHIVE);

    /// <summary>
    ///     Controls if the game can force a different preset if the current preset's criteria are not met.
    /// </summary>
    public static readonly CVarDef<bool>
        GameLobbyFallbackEnabled = CVarDef.Create("finster_game.fallbackenabled", true, CVar.ARCHIVE);

    /// <summary>
    ///     The preset for the game to fall back to if the selected preset could not be used, and fallback is enabled.
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyFallbackPreset = CVarDef.Create("finster_game.fallbackpreset", "Extended", CVar.ARCHIVE);

    /// <summary>
    ///     Controls if people can win the game in Suspicion or Deathmatch.
    /// </summary>
    public static readonly CVarDef<bool>
        GameLobbyEnableWin = CVarDef.Create("finster_game.enablewin", true, CVar.ARCHIVE);

    /// <summary>
    ///     Minimum time between Basic station events in seconds
    /// </summary>
    public static readonly CVarDef<int> // 5 Minutes
        GameEventsBasicMinimumTime = CVarDef.Create("finster_game.events_basic_minimum_time", 300, CVar.SERVERONLY | CVar.ARCHIVE);

    /// <summary>
    ///     Maximum time between Basic station events in seconds
    /// </summary>
    public static readonly CVarDef<int> // 25 Minutes
        GameEventsBasicMaximumTime = CVarDef.Create("finster_game.events_basic_maximum_time", 1500, CVar.SERVERONLY | CVar.ARCHIVE);

    /// <summary>
    ///     Minimum time between Ramping station events in seconds
    /// </summary>
    public static readonly CVarDef<int> // 4 Minutes
        GameEventsRampingMinimumTime = CVarDef.Create("finster_game.events_ramping_minimum_time", 240, CVar.SERVERONLY | CVar.ARCHIVE);

    /// <summary>
    ///     Maximum time between Ramping station events in seconds
    /// </summary>
    public static readonly CVarDef<int> // 12 Minutes
        GameEventsRampingMaximumTime = CVarDef.Create("finster_game.events_ramping_maximum_time", 720, CVar.SERVERONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<int> // 40 seconds
        GameEventsOscillatingMinimumTime = CVarDef.Create("finster_game.events_oscillating_minimum_time", 40, CVar.SERVERONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<int> // 20 Minutes - which constitutes a minimum of 120 seconds between events in Irregular and 280 seconds in Extended Irregular
        GameEventsOscillatingAverageTime = CVarDef.Create("finster_game.events_oscillating_average_time", 1200, CVar.SERVERONLY | CVar.ARCHIVE);

    /// <summary>
    ///     Controls the maximum number of character slots a player is allowed to have.
    /// </summary>
    public static readonly CVarDef<int>
        GameMaxCharacterSlots = CVarDef.Create("finster_game.maxcharacterslots", 30, CVar.ARCHIVE | CVar.SERVERONLY);

    /// <summary>
    ///     Controls the game map prototype to load. SS14 stores these prototypes in Prototypes/Maps.
    /// </summary>
    public static readonly CVarDef<string>
        GameMap = CVarDef.Create("finster_game.map", string.Empty, CVar.SERVERONLY);

    /// <summary>
    /// If roles should be restricted based on whether or not they are whitelisted.
    /// </summary>
    public static readonly CVarDef<bool>
        GameRoleWhitelist = CVarDef.Create("finster_game.role_whitelist", true, CVar.SERVER | CVar.REPLICATED);
    ...
    /// </summary>
    public static readonly CVarDef<bool>
        UsePersistence = CVarDef.Create("finster_game.usepersistence", false, CVar.ARCHIVE);
    ...
    /// </summary>
    public static readonly CVarDef<string>
        PersistenceMap = CVarDef.Create("finster_game.persistencemap", "Empty", CVar.ARCHIVE);

    /// <summary>
    ///     Prototype to use for map pool.
    /// </summary>
    public static readonly CVarDef<string>
        GameMapPool = CVarDef.Create("finster_game.map_pool", "DefaultMapPool", CVar.SERVERONLY);
    ...
    /// </summary>
    public static readonly CVarDef<int>
        GameMapMemoryDepth = CVarDef.Create("finster_game.map_memory_depth", 16, CVar.SERVERONLY);

    /// <summary>
    /// Is map rotation enabled?
    /// </summary>
    public static readonly CVarDef<bool>
        GameMapRotation = CVarDef.Create("finster_game.map_rotation", true, CVar.SERVERONLY);

    /// <summary>
    /// If roles should be restricted based on time.
    /// </summary>
    public static readonly CVarDef<bool>
        GameRoleTimers = CVarDef.Create("finster_game.role_timers", true, CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    /// Whether or not disconnecting inside of a cryopod should remove the character or just store them until they reconnect.
    /// </summary>
    public static readonly CVarDef<bool>
        GameCryoSleepRejoining = CVarDef.Create("finster_game.cryo_sleep_rejoining", false, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> RoundEndPVSOverrides =
        CVarDef.Create("finster_game.round_end_pvs_overrides", true, CVar.SERVERONLY);

    /// <summary>
    ///     When enabled, guests will be assigned permanent UIDs and will have their preferences stored.
    /// </summary>
    public static readonly CVarDef<bool> GamePersistGuests =
        CVarDef.Create("finster_game.persistguests", true, CVar.ARCHIVE | CVar.SERVERONLY);

    public static readonly CVarDef<bool> GameDiagonalMovement =
        CVarDef.Create("finster_game.diagonalmovement", true, CVar.ARCHIVE);

    public static readonly CVarDef<int> SoftMaxPlayers =
        CVarDef.Create("finster_game.soft_max_players", 30, CVar.SERVERONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<int> GameServerFullReconnectDelay =
        CVarDef.Create("finster_game.server_full_reconnect_delay", 30, CVar.SERVERONLY);

    /// <summary>
    /// Whether or not panic bunker is currently enabled.
    /// </summary>
    public static readonly CVarDef<bool> PanicBunkerEnabled =
        CVarDef.Create("finster_game.panic_bunker.enabled", false, CVar.NOTIFY | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> PanicBunkerDisableWithAdmins =
        CVarDef.Create("finster_game.panic_bunker.disable_with_admins", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> PanicBunkerEnableWithoutAdmins =
        CVarDef.Create("finster_game.panic_bunker.enable_without_admins", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> PanicBunkerCountDeadminnedAdmins =
        CVarDef.Create("finster_game.panic_bunker.count_deadminned_admins", false, CVar.SERVERONLY);

    /// <summary>
    /// Show reason of disconnect for user or not.
    /// </summary>
    public static readonly CVarDef<bool> PanicBunkerShowReason =
        CVarDef.Create("finster_game.panic_bunker.show_reason", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> PanicBunkerMinAccountAge =
        CVarDef.Create("finster_game.panic_bunker.min_account_age", 24, CVar.SERVERONLY);

    /// <summary>
    /// Minimal overall played time.
    /// </summary>
    public static readonly CVarDef<int> PanicBunkerMinOverallHours =
        CVarDef.Create("finster_game.panic_bunker.min_overall_hours", 10, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> PanicBunkerCustomReason =
        CVarDef.Create("finster_game.panic_bunker.custom_reason", string.Empty, CVar.SERVERONLY);

    /// <summary>
    /// Allow bypassing the panic bunker if the user is whitelisted.
    /// </summary>
    public static readonly CVarDef<bool> BypassBunkerWhitelist =
        CVarDef.Create("finster_game.panic_bunker.whitelisted_can_bypass", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> BabyJailEnabled  =
        CVarDef.Create("finster_game.baby_jail.enabled", false, CVar.NOTIFY | CVar.REPLICATED | CVar.SERVER);

    /// <summary>
    /// Show reason of disconnect for user or not.
    /// </summary>
    public static readonly CVarDef<bool> BabyJailShowReason =
        CVarDef.Create("finster_game.baby_jail.show_reason", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> BabyJailMaxAccountAge =
        CVarDef.Create("finster_game.baby_jail.max_account_age", 24, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> BabyJailMaxOverallHours =
        CVarDef.Create("finster_game.baby_jail.max_overall_hours", 2, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> BabyJailCustomReason =
        CVarDef.Create("finster_game.baby_jail.custom_reason", string.Empty, CVar.SERVERONLY);

    /// <summary>
    /// Allow bypassing the baby jail if the user is whitelisted.
    /// </summary>
    public static readonly CVarDef<bool> BypassBabyJailWhitelist =
        CVarDef.Create("finster_game.baby_jail.whitelisted_can_bypass", true, CVar.SERVERONLY);

    /// <summary>
    /// Make people bonk when trying to climb certain objects like tables.
    /// </summary>
    public static readonly CVarDef<bool> GameTableBonk =
        CVarDef.Create("finster_game.table_bonk", false, CVar.REPLICATED);

    /// <summary>
    /// Whether or not status icons are rendered for everyone.
    /// </summary>
    public static readonly CVarDef<bool> GlobalStatusIconsEnabled =
        CVarDef.Create("finster_game.global_status_icons_enabled", true, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> LocalStatusIconsEnabled =
        CVarDef.Create("finster_game.local_status_icons_enabled", true, CVar.CLIENTONLY);
    ...
    public static readonly CVarDef<bool> DebugCoordinatesAdminOnly =
        CVarDef.Create("finster_game.debug_coordinates_admin_only", true, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> GameAutoEatFood =
        CVarDef.Create("finster_game.auto_eat_food", false, CVar.REPLICATED);

    /// <summary>
    ///     Whether to repeat drinking doafters after completion
    /// </summary>
    public static readonly CVarDef<bool> GameAutoEatDrinks =
        CVarDef.Create("finster_game.auto_eat_drinks", false, CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> AllowSlotQuickSwap =
        CVarDef.Create("finster_game.slot_quick_swap", false, CVar.REPLICATED);
    ...
    public static readonly CVarDef<int> RoundStartFailShutdownCount =
        CVarDef.Create("finster_game.round_start_fail_shutdown_count", 5, CVar.SERVERONLY | CVar.SERVER);
#endif
    ...
    public static readonly CVarDef<int> GameAlertLevelChangeDelay =
        CVarDef.Create("finster_game.alert_level_change_delay", 30, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> RoundRestartTime =
        CVarDef.Create("finster_game.round_restart_time", 120f, CVar.SERVERONLY);

    /// <summary>
    /// The prototype to use for secret weights.
    /// </summary>
    public static readonly CVarDef<string> SecretWeightPrototype =
        CVarDef.Create("finster_game.secret_weight_prototype", "Secret", CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> RoundEndSoundCollection =
        CVarDef.Create("finster_game.round_end_sound_collection", "RoundEnd", CVar.SERVERONLY);
