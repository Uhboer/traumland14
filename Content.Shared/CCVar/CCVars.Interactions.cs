...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> DragDropDeadZone =
        CVarDef.Create("finster_control.drag_dead_zone", 12f, CVar.CLIENTONLY | CVar.ARCHIVE);

    /// <summary>
    ///     Toggles whether the walking key is a toggle or a held key.
    /// </summary>
    public static readonly CVarDef<bool> ToggleWalk =
        CVarDef.Create("finster_control.toggle_walk", true, CVar.CLIENTONLY | CVar.ARCHIVE);

    /// <summary>
    /// Whether the player mob is walking by default instead of running.
    /// </summary>
    public static readonly CVarDef<bool> DefaultWalk =
        CVarDef.Create("finster_control.default_walk", true, CVar.CLIENT | CVar.REPLICATED | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<int> InteractionRateLimitCount =
        CVarDef.Create("finster_interaction.rate_limit_count", 5, CVar.SERVER | CVar.REPLICATED);

    /// <seealso cref="InteractionRateLimitCount"/>
    public static readonly CVarDef<float> InteractionRateLimitPeriod =
        CVarDef.Create("finster_interaction.rate_limit_period", 0.5f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<int> InteractionRateLimitAnnounceAdminsDelay =
        CVarDef.Create("finster_interaction.rate_limit_announce_admins_delay", 120, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> StaticStorageUI =
        CVarDef.Create("finster_control.static_storage_ui", true, CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<bool> OpaqueStorageWindow =
        CVarDef.Create("finster_control.opaque_storage_background", false, CVar.CLIENTONLY | CVar.ARCHIVE);
}
