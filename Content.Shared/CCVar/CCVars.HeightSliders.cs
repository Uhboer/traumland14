...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> HeightAdjustModifiesHitbox =
        CVarDef.Create("finster_heightadjust.modifies_hitbox", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> HeightAdjustModifiesZoom =
        CVarDef.Create("finster_heightadjust.modifies_zoom", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> HeightAdjustModifiesBloodstream =
        CVarDef.Create("finster_heightadjust.modifies_bloodstream", true, CVar.SERVERONLY);
}
