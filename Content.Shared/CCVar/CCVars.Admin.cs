...
public sealed partial class CCVars
{
    public static readonly CVarDef<bool> AdminAnnounceLogin =
        CVarDef.Create("finster_admin.announce_login", true, CVar.SERVERONLY);

    public static readonly CVarDef<bool> AdminAnnounceLogout =
        CVarDef.Create("finster_admin.announce_logout", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> AdminApiToken =
        CVarDef.Create("finster_admin.api_token", string.Empty, CVar.SERVERONLY | CVar.CONFIDENTIAL);
    ...
    public static readonly CVarDef<bool> SeeOwnNotes =
        CVarDef.Create("finster_admin.see_own_notes", false, CVar.ARCHIVE | CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<bool> AdminNewPlayerJoinSound =
        CVarDef.Create("finster_admin.new_player_join_sound", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<double> NoteFreshDays =
        CVarDef.Create("finster_admin.note_fresh_days", 91.31055, CVar.ARCHIVE | CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<double> NoteStaleDays =
        CVarDef.Create("finster_admin.note_stale_days", 365.2422, CVar.ARCHIVE | CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<float> MessageWaitTime =
        CVarDef.Create("finster_admin.message_wait_time", 3f, CVar.ARCHIVE | CVar.REPLICATED | CVar.SERVER);

    /// <summary>
    ///     Default severity for role bans
    /// </summary>
    public static readonly CVarDef<string> RoleBanDefaultSeverity =
        CVarDef.Create("finster_admin.role_ban_default_severity", "medium", CVar.ARCHIVE | CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    ///     Default severity for department bans
    /// </summary>
    public static readonly CVarDef<string> DepartmentBanDefaultSeverity =
        CVarDef.Create("finster_admin.department_ban_default_severity", "medium", CVar.ARCHIVE | CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    ///     Default severity for server bans
    /// </summary>
    public static readonly CVarDef<string> ServerBanDefaultSeverity =
        CVarDef.Create("finster_admin.server_ban_default_severity", "High", CVar.ARCHIVE | CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    ///     Whether a server ban will ban the player's ip by default.
    /// </summary>
    public static readonly CVarDef<bool> ServerBanIpBanDefault =
        CVarDef.Create("finster_admin.server_ban_ip_ban_default", true, CVar.ARCHIVE | CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> ServerBanHwidBanDefault =
        CVarDef.Create("finster_admin.server_ban_hwid_ban_default", true, CVar.ARCHIVE | CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> ServerBanUseLastDetails =
        CVarDef.Create("finster_admin.server_ban_use_last_details", true, CVar.ARCHIVE | CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<bool> ServerBanErasePlayer =
        CVarDef.Create("finster_admin.server_ban_erase_player", false, CVar.ARCHIVE | CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<int> AdminAlertMinPlayersSharingConnection =
        CVarDef.Create("finster_admin.alert.min_players_sharing_connection", -1, CVar.SERVERONLY);

    /// <summary>
    ///     Minimum explosion intensity to create an admin alert message. -1 to disable the alert.
    /// </summary>
    public static readonly CVarDef<int> AdminAlertExplosionMinIntensity =
        CVarDef.Create("finster_admin.alert.explosion_min_intensity", 60, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> AdminAlertParticleAcceleratorMinPowerState =
        CVarDef.Create("finster_admin.alert.particle_accelerator_min_power_state", 3, CVar.SERVERONLY);

    /// <summary>
    ///     Should the ban details in admin channel include PII? (IP, HWID, etc)
    /// </summary>
    public static readonly CVarDef<bool> AdminShowPIIOnBan =
        CVarDef.Create("finster_admin.show_pii_onban", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> AdminDeadminOnJoin =
        CVarDef.Create("finster_admin.deadmin_on_join", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> AdminAhelpOverrideClientName =
        CVarDef.Create("finster_admin.override_adminname_in_client_ahelp", string.Empty, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> NewPlayerThreshold =
        CVarDef.Create("finster_admin.new_player_threshold", 0, CVar.ARCHIVE | CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<float> AdminAfkTime =
        CVarDef.Create("finster_admin.afk_time", 600f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> AdminBypassMaxPlayers =
        CVarDef.Create("finster_admin.bypass_max_players", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> AdminUseCustomNamesAdminRank =
        CVarDef.Create("finster_admin.use_custom_names_admin_rank", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> AdminsCountForMaxPlayers =
        CVarDef.Create("finster_admin.admins_count_for_max_players", false, CVar.SERVERONLY);

    public static readonly CVarDef<bool> BanHardwareIds =
        CVarDef.Create("finster_ban.hardware_ids", true, CVar.SERVERONLY);
}
