...
public sealed partial class CCVars
{
    public static readonly CVarDef<bool> ConsoleLoginLocal =
        CVarDef.Create("finster_console.loginlocal", true, CVar.ARCHIVE | CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> ConsoleLoginHostUser =
        CVarDef.Create("finster_console.login_host_user", "", CVar.ARCHIVE | CVar.SERVERONLY);
}
