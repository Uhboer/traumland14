...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> SpaceWind =
        CVarDef.Create("finster_atmos.space_wind", true, CVar.SERVERONLY);

    public static readonly CVarDef<float> SpaceWindStrengthMultiplier =
        CVarDef.Create("finster_atmos.space_wind_strength_multiplier", 1f, CVar.SERVERONLY);

    /// <summary>
    ///     Divisor from maxForce (pressureDifference * 2.25f) to force applied on objects.
    /// </summary>
    public static readonly CVarDef<float> SpaceWindPressureForceDivisorThrow =
        CVarDef.Create("finster_atmos.space_wind_pressure_force_divisor_throw", 15f, CVar.SERVERONLY);

    /// <summary>
    ///     Divisor from maxForce (pressureDifference * 2.25f) to force applied on objects.
    /// </summary>
    public static readonly CVarDef<float> SpaceWindPressureForceDivisorPush =
        CVarDef.Create("finster_atmos.space_wind_pressure_force_divisor_push", 2500f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> SpaceWindMaxVelocity =
        CVarDef.Create("finster_atmos.space_wind_max_velocity", 15f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> SpaceWindMaxPushForce =
        CVarDef.Create("finster_atmos.space_wind_max_push_force", 20f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> SpaceWindMinimumCalculatedMass =
        CVarDef.Create("finster_atmos.space_wind_minimum_calculated_mass", 5f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> SpaceWindMaximumCalculatedInverseMass =
        CVarDef.Create("finster_atmos.space_wind_maximum_calculated_inverse_mass", 0.04f, CVar.SERVERONLY);

    /// <summary>
    ///     Whether monstermos tile equalization is enabled.
    /// </summary>
    public static readonly CVarDef<bool> MonstermosEqualization =
        CVarDef.Create("finster_atmos.monstermos_equalization", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> MonstermosDepressurization =
        CVarDef.Create("finster_atmos.monstermos_depressurization", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> MonstermosRipTiles =
        CVarDef.Create("finster_atmos.monstermos_rip_tiles", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> MonstermosRipTilesMinimumPressure =
        CVarDef.Create("finster_atmos.monstermos_rip_tiles_min_pressure", 20f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> AtmosGridImpulse =
        CVarDef.Create("finster_atmos.grid_impulse", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> AtmosSpacingEscapeRatio =
        CVarDef.Create("finster_atmos.mmos_spacing_speed", 0.05f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> AtmosSpacingMinGas =
        CVarDef.Create("finster_atmos.mmos_min_gas", 2.0f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> AtmosSpacingMaxWind =
        CVarDef.Create("finster_atmos.mmos_max_wind", 500f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> MonstermosUseExpensiveAirflow =
        CVarDef.Create("finster_atmos.mmos_expensive_airflow", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> AtmosSpeedup =
        CVarDef.Create("finster_atmos.speedup", 8f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> AtmosHeatScale =
        CVarDef.Create("finster_atmos.heat_scale", 8f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> AtmosHumanoidThrowMultiplier =
        CVarDef.Create("finster_atmos.humanoid_throw_multiplier", 2f, CVar.SERVERONLY);
}
