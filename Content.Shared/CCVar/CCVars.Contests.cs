...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> DoContestsSystem =
        CVarDef.Create("finster_contests.do_contests_system", true, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<bool> AllowClampOverride =
        CVarDef.Create("finster_contests.allow_clamp_override", true, CVar.REPLICATED | CVar.SERVER);
    /// <summary>
    ...
    public static readonly CVarDef<bool> DoMassContests =
        CVarDef.Create("finster_contests.do_mass_contests", true, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<bool> DoStaminaContests =
        CVarDef.Create("finster_contests.do_stamina_contests", true, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<bool> DoHealthContests =
        CVarDef.Create("finster_contests.do_health_contests", true, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<bool> DoMindContests =
        CVarDef.Create("finster_contests.do_mind_contests", true, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<bool> DoMoodContests =
        CVarDef.Create("finster_contests.do_mood_contests", true, CVar.REPLICATED | CVar.SERVER);
    ...
    public static readonly CVarDef<float> MassContestsMaxPercentage =
        CVarDef.Create("finster_contests.max_percentage", 0.25f, CVar.REPLICATED | CVar.SERVER);
}
