...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> CameraRotationLocked =
        CVarDef.Create("finster_shuttle.camera_rotation_locked", false, CVar.REPLICATED);

    /// <summary>
    /// Whether the arrivals terminal should be on a planet map.
    /// </summary>
    public static readonly CVarDef<bool> ArrivalsPlanet =
        CVarDef.Create("finster_shuttle.arrivals_planet", false, CVar.SERVERONLY);

    /// <summary>
    /// Whether the arrivals shuttle is enabled.
    /// </summary>
    public static readonly CVarDef<bool> ArrivalsShuttles =
        CVarDef.Create("finster_shuttle.arrivals", false, CVar.SERVERONLY);

    /// <summary>
    /// The map to use for the arrivals station.
    /// </summary>
    public static readonly CVarDef<string> ArrivalsMap =
        CVarDef.Create("finster_shuttle.arrivals_map", "/Maps/Misc/terminal.yml", CVar.SERVERONLY);

    /// <summary>
    /// Cooldown between arrivals departures. This should be longer than the FTL time or it will double cycle.
    /// </summary>
    public static readonly CVarDef<float> ArrivalsCooldown =
        CVarDef.Create("finster_shuttle.arrivals_cooldown", 50f, CVar.SERVERONLY);

    /// <summary>
    /// Time it takes the shuttle to spin up it's hyper drive and jump
    /// </summary>
    public static readonly CVarDef<float> ArrivalsStartupTime=
        CVarDef.Create("finster_shuttle.arrivals_startup_time", 5.5f, CVar.SERVERONLY);

    /// <summary>
    /// Time spent in hyperspace
    /// </summary>
    public static readonly CVarDef<float> ArrivalsHyperspaceTime =
        CVarDef.Create("finster_shuttle.arrivals_hyperspace_time", 20f, CVar.SERVERONLY);

    /// <summary>
    /// Are players allowed to return on the arrivals shuttle.
    /// </summary>
    public static readonly CVarDef<bool> ArrivalsReturns =
        CVarDef.Create("finster_shuttle.arrivals_returns", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> GodmodeArrivals =
        CVarDef.Create("finster_shuttle.godmode_arrivals", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> FTLMassLimit =
        CVarDef.Create("finster_shuttle.mass_limit", 300f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> HyperspaceKnockdownTime =
        CVarDef.Create("finster_shuttle.hyperspace_knockdown_time", 5f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> SpaceFrictionStrength =
        CVarDef.Create("finster_shuttle.space_friction_strength", 0.0015f, CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> AnchorDampeningStrength =
        CVarDef.Create("finster_shuttle.ancho_dampening_strength", 0.5f, CVar.REPLICATED);

    /// <summary>
    /// Is the emergency shuttle allowed to be early launched.
    /// </summary>
    public static readonly CVarDef<bool> EmergencyEarlyLaunchAllowed =
        CVarDef.Create("finster_shuttle.emergency_early_launch_allowed", false, CVar.SERVERONLY);

    /// <summary>
    /// How long the emergency shuttle remains docked with the station, in seconds.
    /// </summary>
    public static readonly CVarDef<float> EmergencyShuttleDockTime =
        CVarDef.Create("finster_shuttle.emergency_dock_time", 240f, CVar.SERVERONLY);

    /// <summary>
    /// How long after the console is authorized for the shuttle to early launch.
    /// </summary>
    public static readonly CVarDef<float> EmergencyShuttleAuthorizeTime =
        CVarDef.Create("finster_shuttle.emergency_authorize_time", 10f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> EmergencyShuttleMinTransitTime =
        CVarDef.Create("finster_shuttle.emergency_transit_time_min", 90f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> EmergencyShuttleMaxTransitTime =
        CVarDef.Create("finster_shuttle.emergency_transit_time_max", 180f, CVar.SERVERONLY);

    /// <summary>
    /// Whether the emergency shuttle is enabled or should the round just end.
    /// </summary>
    public static readonly CVarDef<bool> EmergencyShuttleEnabled =
        CVarDef.Create("finster_shuttle.emergency", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> EmergencyRecallTurningPoint =
        CVarDef.Create("finster_shuttle.recall_turning_point", 0.5f, CVar.SERVERONLY);

    /// <summary>
    ///     Time in minutes after round start to auto-call the shuttle. Set to zero to disable.
    /// </summary>
    public static readonly CVarDef<int> EmergencyShuttleAutoCallTime =
        CVarDef.Create("finster_shuttle.auto_call_time", 120, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> EmergencyShuttleAutoCallExtensionTime =
        CVarDef.Create("finster_shuttle.auto_call_extension_time", 30, CVar.SERVERONLY);
}
