...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> AhelpRateLimitPeriod =
        CVarDef.Create("finster_ahelp.rate_limit_period", 2f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> AhelpRateLimitCount =
        CVarDef.Create("finster_ahelp.rate_limit_count", 10, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> AhelpAdminPrefix =
        CVarDef.Create("finster_ahelp.admin_prefix", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> AhelpAdminPrefixWebhook =
        CVarDef.Create("finster_ahelp.admin_prefix_webhook", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> UseDiscordRoleColor =
        CVarDef.Create("finster_admin.use_discord_role_color", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> UseDiscordRoleName =
        CVarDef.Create("finster_admin.use_discord_role_name", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> DiscordReplyPrefix =
        CVarDef.Create("finster_admin.discord_reply_prefix", "(DC) ", CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> AdminBwoinkColor =
        CVarDef.Create("finster_admin.admin_bwoink_color", "red", CVar.SERVERONLY);
    ...
    public static readonly CVarDef<string> DiscordReplyColor =
        CVarDef.Create("finster_admin.discord_reply_color", string.Empty, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> UseAdminOOCColorInBwoinks =
        CVarDef.Create("finster_admin.bwoink_use_admin_ooc_color", false, CVar.SERVERONLY);
}
