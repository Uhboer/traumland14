...
{
    public static readonly CVarDef<bool> HolidaysEnabled = CVarDef.Create("finster_holidays.enabled", true, CVar.SERVERONLY);
    public static readonly CVarDef<bool> BrandingSteam = CVarDef.Create("finster_branding.steam", false, CVar.CLIENTONLY);
    public static readonly CVarDef<int> EntityMenuGroupingType = CVarDef.Create("finster_entity_menu", 0, CVar.CLIENTONLY);

    /// <summary>
    ///     Should we pre-load all of the procgen atlasses.
    /// </summary>
    public static readonly CVarDef<bool> ProcgenPreload =
        CVarDef.Create("finster_procgen.preload", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> BiomassEasyMode =
        CVarDef.Create("finster_biomass.easy_mode", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> AnomalyGenerationGridBoundsScale =
        CVarDef.Create("finster_anomaly.generation_grid_bounds_scale", 0.6f, CVar.SERVERONLY);

    /// <summary>
    ///     How long a client can go without any input before being considered AFK.
    /// </summary>
    public static readonly CVarDef<float> AfkTime =
        CVarDef.Create("finster_afk.time", 60f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int>
        FlavorLimit = CVarDef.Create("finster_flavor.limit", 10, CVar.SERVERONLY);

    public static readonly CVarDef<string> DestinationFile =
        CVarDef.Create("finster_autogen.destination_file", "", CVar.SERVER | CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> ResourceUploadingStoreEnabled =
        CVarDef.Create("finster_netres.store_enabled", true, CVar.SERVER | CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> ResourceUploadingStoreDeletionDays =
        CVarDef.Create("finster_netres.store_deletion_days", 30, CVar.SERVER | CVar.SERVERONLY);
    ...
    public static readonly CVarDef<float> UpdateRestartDelay =
        CVarDef.Create("finster_update.restart_delay", 20f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> FireAlarmAllAccess =
        CVarDef.Create("finster_firealarm.allaccess", true, CVar.SERVERONLY);

    /// <summary>
    ///     Time between play time autosaves, in seconds.
    /// </summary>
    public static readonly CVarDef<float>
        PlayTimeSaveInterval = CVarDef.Create("finster_playtime.save_interval", 900f, CVar.SERVERONLY);

    /// <summary>
    ///     The maximum amount of time the entity GC can process, in ms.
    /// </summary>
    public static readonly CVarDef<int> GCMaximumTimeMs =
        CVarDef.Create("finster_entgc.maximum_time_ms", 5, CVar.SERVERONLY);

    public static readonly CVarDef<bool> GatewayGeneratorEnabled =
        CVarDef.Create("finster_gateway.generator_enabled", true);

    public static readonly CVarDef<string> TippyEntity =
        CVarDef.Create("finster_tippy.entity", "Tippy", CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> PointingCooldownSeconds =
        CVarDef.Create("finster_pointing.cooldown_seconds", 0.5f, CVar.SERVERONLY);

    /// <summary>
    ///     The amount of time between NPC Silicons draining their battery in seconds.
    /// </summary>
    public static readonly CVarDef<float> SiliconNpcUpdateTime =
        CVarDef.Create("finster_silicon.npcupdatetime", 1.5f, CVar.SERVERONLY);

    public static readonly CVarDef<bool> AllowScreamAction =
        CVarDef.Create("finster_vocal.allow_scream_action", true, CVar.SERVERONLY);
}
