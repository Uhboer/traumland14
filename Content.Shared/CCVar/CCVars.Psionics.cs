...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> GlimmerEnabled =
        CVarDef.Create("finster_glimmer.enabled", true, CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> GlimmerLinearDecayPerMinute =
        CVarDef.Create("finster_glimmer.linear_decay_per_minute", 6f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> PsionicRollsEnabled =
        CVarDef.Create("finster_psionics.rolls_enabled", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> ScarierMindbreaking =
        CVarDef.Create("finster_psionics.scarier_mindbreaking", false, CVar.SERVERONLY);

    /// <summary>
    /// Allow Ethereal Ent to PassThrough Walls/Objects while in Ethereal.
    /// </summary>
    public static readonly CVarDef<bool> EtherealPassThrough =
        CVarDef.Create("finster_ic.EtherealPassThrough", false, CVar.SERVER);
}
