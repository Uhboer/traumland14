...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> ReducedMotion =
        CVarDef.Create("finster_accessibility.reduced_motion", false, CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<float> ScreenShakeIntensity =
        CVarDef.Create("finster_accessibility.screen_shake_intensity", 1f, CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    public static readonly CVarDef<bool> AccessibilityColorblindFriendly =
        CVarDef.Create("finster_accessibility.colorblind_friendly", false, CVar.CLIENTONLY | CVar.ARCHIVE);

    /// <summary>
    /// Disables all vision filters for species like Vulpkanin or Harpies. There are good reasons someone might want to disable these.
    /// </summary>
    public static readonly CVarDef<bool> NoVisionFilters =
        CVarDef.Create("finster_accessibility.no_vision_filters", true, CVar.CLIENTONLY | CVar.ARCHIVE);
}
