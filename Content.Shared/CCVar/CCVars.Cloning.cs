...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> CloningBiomassCostMultiplier =
        CVarDef.Create("finster_cloning.biomass_cost_multiplier", 1f, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> CloningReclaimSouledBodies =
        CVarDef.Create("finster_cloning.reclaim_souled_bodies", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> CloningPreserveSex =
        CVarDef.Create("finster_cloning.preserve_sex", false, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> CloningPreserveName =
        CVarDef.Create("finster_cloning.preserve_name", true, CVar.SERVERONLY);
    ...
    public static readonly CVarDef<bool> CloningPreserveFlavorText =
        CVarDef.Create("finster_cloning.preserve_flavor_text", true, CVar.SERVERONLY);

    /// <summary>
    ///     Controls whether or not living people can be cloned.
    /// </summary>
    public static readonly CVarDef<bool> CloningAllowLivingPeople =
        CVarDef.Create("finster_cloning.allow_living_people", true, CVar.SERVERONLY);
}
